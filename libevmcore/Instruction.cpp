...
{ //                                                Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::BALANCE,     { "BALANCE",        0, 1, 1, false, Tier::SpecialTier } },
	...
	{ Instruction::EXTCODESIZE, { "EXTCODESIZE",    0, 1, 1, false, Tier::SpecialTier } },
	{ Instruction::EXTCODECOPY, { "EXTCODECOPY",    0, 4, 0, true, Tier::SpecialTier } },
	...
	{ Instruction::SUICIDE,     { "SUICIDE",        0, 1, 0, true, Tier::SpecialTier } },

	// these are generated by the interpreter - should never be in user code
	{ Instruction::PUSHC,       { "PUSHC",          2, 0, 1, false, Tier::VeryLowTier } },
	{ Instruction::JUMPV,       { "JUMPV",          0, 1, 0, true, Tier::MidTier } },
	{ Instruction::JUMPVI,      { "JUMPVI",         0, 1, 0, true, Tier::HighTier } },
	{ Instruction::STOP,        { "BAD",            0, 0, 0, true, Tier::ZeroTier } },
};
...
InstructionInfo dev::eth::instructionInfo(Instruction _inst)
{
	...
	if (it != c_instructionInfo.end())
		return it->second;
	return InstructionInfo({{}, 0, 0, 0, false, Tier::InvalidTier});
}
